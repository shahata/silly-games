...
const gameTitleImage = "/silly-games/assets/game_title-D9tTbUbj.png";
const pregameImage = "/silly-games/assets/pregame-DVYQT5Ku.png";
const level1Image = "/silly-games/assets/level-1-BgzDeRpY.png";
const barmanImage = "/silly-games/assets/barman-PKekbaKX.png";
...
const customersImage = "/silly-games/assets/customers-BPlNYiZk.png";
...
const zipUpSound = "/silly-games/assets/zip_up-NopGOQDR.mp3";
const zipDownSound = "/silly-games/assets/zip_down-aDPrgcc0.mp3";
const ohSuzannaSound = "/silly-games/assets/oh_suzanna-pQz6tSne.mp3";
...
const throwMugSound = "/silly-games/assets/throw_mug-6SArNzig.mp3";
...
const fullMugSound = "/silly-games/assets/full_mug-DLzgtZ5V.mp3";
...
const outDoorSound = "/silly-games/assets/out_door-BVaAh28T.mp3";
const laughingSound = "/silly-games/assets/laughing-DXZk7KY9.mp3";
const getReadyToServeSound = "/silly-games/assets/get_ready_to_serve-GrFq-ynX.mp3";
const youLoseSound = "/silly-games/assets/you_lose-fy4sl49c.mp3";
const collectTipSound = "/silly-games/assets/collect_tip-CfGCPipc.mp3";
const tipAppearSound = "/silly-games/assets/tip_appear-D_SVu7xV.mp3";
var g_imageData = [
